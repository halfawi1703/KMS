...
class Auth extends Web_Controller
{
    ...
    public function login()
    {
        ...
        if (@$auth->status == 'success') {
            ...
            // setcookie('_kms_session', $output->data->access_token, time() + 60 * 60 * 12, "/");
            // setcookie('_kms_rsession', $output->data->refresh_token, time() + 60 * 60 * 24 * 14, "/");
        } else {
    ...
    public function logout()
    {
        ...
        unset($_COOKIE['_kms_session']);
        unset($_COOKIE['_kms_rsession']);
