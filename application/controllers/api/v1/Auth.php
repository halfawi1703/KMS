...
class Auth extends KMS_Controller
{
    ...
    public function login_post()
    {
        ...
        $user = $this->User_m->get_user(1, 1, false, false, $email);
        ...
        $user_role = $this->User_m->get_user_role(1, 1, ['id', 'role_id'], false, $user->id);
        ...
        $data_insert_session = [
            ...
            'lng' => null,
            'status' => 1,
            'expired_at' => date('c',$payload_token->exp),
            'last_activity_at' => date('c',$payload_token->iat),
            'created_at' => date('c',$payload_token->iat),
            'updated_at' => date('c',$payload_token->iat)
        ];
    ...
    public function logout_post()
    {
        ...
        $update_session = $this->User_session_m->update_session($data_update_session, false, $user_id, $session_id, false, false, 1);
