...
class KMS_Controller extends REST_Controller
{
    ...
    {
        $language = (@$this->input->get_request_header('Accept-Language') == 'id') ? 'indonesian' : 'english';
    ...
    protected function auth()
    {
        ...
        $get_session = $this->User_session_m->get_session(1, 1, false, false, false, false, $access_token);
