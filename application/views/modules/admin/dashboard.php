					...
					<div class="row">
						...
						<div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
							<div class="bg-gradient-primary border-radius-lg h-100">
								<img src="<?php echo base_url(); ?>assets/img/shapes/waves-white.svg"
									class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
								<div
									class="position-relative d-flex align-items-center justify-content-center h-100">
									<img class="w-100 position-relative z-index-2 pt-4"
										src="<?php echo base_url(); ?>assets/img/illustrations/rocket-white.png" alt="rocket">
								</div>
							</div>
						</div>
					</div>
		...
		<div class="col-lg-5">
			<div class="card h-100 p-3">
				<div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
					style="background-image: url('<?php echo base_url(); ?>assets/img/ivancik.jpg');">
							...
							<tbody>
								<tr>
									<td>
										<div class="d-flex px-2 py-1">
											<div>
												<img src="<?php echo base_url(); ?>assets/img/small-logos/logo-xd.svg"
								...
								<tr>
									<td>
										<div class="d-flex px-2 py-1">
											<div>
												<img src="<?php echo base_url(); ?>assets/img/small-logos/logo-atlassian.svg"
								...
								<tr>
									<td>
										<div class="d-flex px-2 py-1">
											<div>
												<img src="<?php echo base_url(); ?>assets/img/small-logos/logo-slack.svg"
								...
								<tr>
									<td>
										<div class="d-flex px-2 py-1">
											<div>
												<img src="<?php echo base_url(); ?>assets/img/small-logos/logo-jira.svg"
								...
								<tr>
									<td>
										<div class="d-flex px-2 py-1">
											<div>
												<img src="<?php echo base_url(); ?>assets/img/small-logos/logo-invision.svg"
